...
Se puede crear una variable en el objeto "cuartilesxregion" con este cálculo.

```{r}
cuartilesxregion = cuartilesxregion |>
  mutate(ric = `75%` - `25%`)

#Ojo con las `` cuando tenemos que trabajar con variables que empiezan con números
```
