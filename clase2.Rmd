...
Para est clase se usará la base de datos de comisarias del Perú, que puede ser descargada de la sección microdatos de la web del INEI (ver [aquí](http://iinei.inei.gob.pe/microdatos/)).
...
#comi17 = import("https://github.com/arturomaldonado/Estadistica_1.0/main/comi2017.sav")
...
Podemos fijarnos en el gráfico de distribución de esta variable para ver si se tiene comisarias que nos "atípicas" de la distribución general.
...
-   Como se observa en el gráfico anterior, la desviación estándar es más útil cuando se comparar dos distribuciones.
    Se compara la centralidad y la dispersión de una variable entre dos grupos (o dos distribuciones).
...
¿Mayor complejidad de centros urbanos grandes?
¿Presencia de comisarías especializadas?\
...
Este gráfico no muestra, sin embargo, los valores de la mediana.
