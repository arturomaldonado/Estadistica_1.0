...
data_larga = gather(data2, variable, valor)
```

```{r}
graf1 = ggplot(data_larga, aes(x=variable, y=valor))+
  geom_boxplot()+
  ylab("Votos")+
  xlab("Candidato")+
...
```{r}
data = data |>
  mutate(pobre = ifelse(Pobreza2020 > 34.6, 1, 0))
```
...
![](twitter_3e92b475993838b817babac6914e555d.png){width="556"}
