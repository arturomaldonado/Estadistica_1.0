...
Asumiendo que este dataframe se llama "alumnos", entonces

-   Variable sexo: `alumnos$sexo`

-   Variable educación: `alumnos$educ`

-   Variable edad: `alumnos$edad`
...
Si el dataframe se llama "distritos", entonces:

-   Variable región: `distritos$region`

-   Variable agua: `distritos$agua`

-   Variable posta: `distritos$posta`
...
Imagínese que quiere crear una base de datos de los alumnos del curso.

1.  Proponga un nombre para el dataframe.

2.  Proponga 3 variables (una nominal, una ordinal y una numérica), que no sean las sociodemográficas (sexo, edad, educación).

3.  Cómo se llamarían estas variables en RStudio? Nombre cada una.
